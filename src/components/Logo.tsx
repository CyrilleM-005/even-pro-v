...
const Logo = ({retract}: {retract: boolean}) => {
  return (
    ...
    >
      <div className="w-9 h-9 rounded-xl bg-gradient-to-r from-primary to-secondary flex items-center justify-center shadow-lg backdrop-blur-xl">
        <Sparkles size={22} className="text-primary-content" />
      </div>
